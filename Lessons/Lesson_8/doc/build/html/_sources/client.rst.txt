...
``python client_side.py {имя сервера} {порт} -n или --name {имя пользователя} -p или -password {пароль}``
...
* ``python client_side.py ip_address some_port``
...
* ``python client_side.py ip_address some_port -n test1 -p 123``
